...
<head>
    ...
    <script src="./js/member_modify.js"></script>
            ...
            //nick 중복검사		 
        $("#nick").keyup(function() { 
            console.log($("#nick").val()); // id입력 상자에 id값 입력시
...
<header>
    <h1 class="logo"><a href="../index.html">효성그룹</a></h1>
</header>	 
	<article id="content">  
     ...
     <table>
      ...
      <tr>
         ...
         <tr class="click">
         <td colspan="2">
                 <a class="join" href="#" onclick="check_input()">수정하기</a>
                 <a class="cancel" href="#" onclick="reset_form()">취소하기</a>
             </td>
         </tr>
